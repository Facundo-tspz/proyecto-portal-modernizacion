-- ============================================================
-- migraciones-depuradas / 02_contenido_storage.sql
-- ------------------------------------------------------------------
...
--
-- Contenido: tablas de contenido editable del portal (config_sitio,
-- avisos, capacitaciones, noticias, tarjetas_enlace, destacados_proyectos),
-- su RLS, el bucket de Storage y TODOS los seeds iniciales.
-- Depende de: 01 (helpers es_admin_o_editor).
-- ============================================================
...
-- ---------- Tabla: destacados_proyectos (carrusel del home) ----------
...
create trigger trg_destacados_proyectos_updated before update on public.destacados_proyectos for each row execute function public.set_updated_at_contenido();
...
-- ============================================================
-- Seeds (las claves banner_* fueron eliminadas en 0009 — no se incluyen)
-- ============================================================
